...
export const Text = ({ children, style }) => {
  return <TXT style={{ ...styles.text, ...style }}>{children}</TXT>;
};

export const GrayText = ({ children, style }) => {
  return <TXT style={{ ...styles.grayText, ...style }}>{children}</TXT>;
};

export const Bold = ({ children, style }) => {
  return <TXT style={{ ...styles.bold, ...style }}>{children}</TXT>;
};

export const SemiBold = ({ children, style }) => {
  return <TXT style={{ ...styles.semiBold, ...style }}>{children}</TXT>;
};
